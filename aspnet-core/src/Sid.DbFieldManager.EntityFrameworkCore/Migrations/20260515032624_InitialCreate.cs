...
namespace Sid.DbFieldManager.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppSqlExecutionLogs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TargetDatabaseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DbFieldId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSqlExecutionLogs", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppTargetDatabases",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTargetDatabases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDbTables", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppDbTables_AppTargetDatabases_TargetDatabaseId",
                        column: x => x.TargetDatabaseId,
                        principalTable: "AppTargetDatabases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DbTableId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ...
                    ExecutionStatus = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDbFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppDbFields_AppDbTables_DbTableId",
                        column: x => x.DbTableId,
                        principalTable: "AppDbTables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppDbFields_DbTableId_Name",
                table: "AppDbFields",
                columns: new[] { "DbTableId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppDbTables_Name",
                table: "AppDbTables",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_AppDbTables_TargetDatabaseId",
                table: "AppDbTables",
                column: "TargetDatabaseId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSqlExecutionLogs_CreationTime",
                table: "AppSqlExecutionLogs",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppSqlExecutionLogs_TargetDatabaseId",
                table: "AppSqlExecutionLogs",
                column: "TargetDatabaseId");
