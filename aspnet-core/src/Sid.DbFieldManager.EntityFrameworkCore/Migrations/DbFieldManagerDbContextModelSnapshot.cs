...
{
    [DbContext(typeof(DbFieldManagerDbContext))]
    partial class DbFieldManagerDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sid.DbFieldManager.DbFields.DbField", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasIndex("DbTableId", "Name")
                        .IsUnique();

                    b.ToTable("AppDbFields", (string)null);
                });

            modelBuilder.Entity("Sid.DbFieldManager.DbTables.DbTable", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TargetDatabaseId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppDbTables", (string)null);
                });

            modelBuilder.Entity("Sid.DbFieldManager.SqlExecutionLogs.SqlExecutionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSqlExecutionLogs", (string)null);
                });

            modelBuilder.Entity("Sid.DbFieldManager.TargetDatabases.TargetDatabase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTargetDatabases", (string)null);
                });
            ...
            modelBuilder.Entity("Sid.DbFieldManager.DbFields.DbField", b =>
                {
                    b.HasOne("Sid.DbFieldManager.DbTables.DbTable", "DbTable")
                        .WithMany("Fields")
            ...
            modelBuilder.Entity("Sid.DbFieldManager.DbTables.DbTable", b =>
                {
                    b.HasOne("Sid.DbFieldManager.TargetDatabases.TargetDatabase", "TargetDatabase")
                        .WithMany("Tables")
